...
-- Add trigger function to log admin access to sales inquiries
...
-- Add audit triggers for admin access logging
DROP TRIGGER IF EXISTS sales_inquiry_update_audit_trigger ON public.sales_inquiries;
DROP TRIGGER IF EXISTS sales_inquiry_delete_audit_trigger ON public.sales_inquiries;

CREATE TRIGGER sales_inquiry_update_audit_trigger
  AFTER UPDATE ON public.sales_inquiries
  FOR EACH ROW EXECUTE FUNCTION public.log_sales_inquiry_access();

CREATE TRIGGER sales_inquiry_delete_audit_trigger
  AFTER DELETE ON public.sales_inquiries
  FOR EACH ROW EXECUTE FUNCTION public.log_sales_inquiry_access();